...
const TrailerTitle = ({title,overview}) => {
  ...
  return (
    <div className='w-full h-[100%] pt-[20%] px-24 flex justify-between absolute text-white bg-gradient-to-r from-black'>
    <div className='h-full '>
        <h1 className='text-4xl font-bold'>{title}</h1>
        <p className='text-lg py-6 w-5/12'>{!readMore && overview.length>200 ? overview.substring(0,200)+"..." : overview}</p>
        <div className='flex '>
